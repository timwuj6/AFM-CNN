...
val_loader = DataLoader(val_dataset, batch_size = batch_size, shuffle = False, pin_memory=False)#, drop_last=True)
...
optimizer = optim.Adam(model_micro.parameters(), lr=0.001)#, weight_decay = 0.0001) # 0.005 was used in the saved model I
...
for epoch in range(1, 300):  # loop over the dataset multiple times  2000,3000
  running_loss = 0.0
  val_running_loss = 0.0
  mean_abs_error = 0.00
  val_mean_abs_error = 0.00
  ...
  print(f'Epoch{epoch}: loss: {running_loss /train_nbatch :.3f} val_loss: {val_running_loss / val_nbatch:.3f}, mae: {mean_abs_error/train_nbatch :.4f} val_mae:  {val_mean_abs_error /val_nbatch :.4f}')
...
checkpoint = {'state_dict': model_micro.state_dict(),
              ...
              'epoch': epoch,
              'loss': loss}
torch.save(checkpoint, '/noether/s0/cfw5463/Model/2000epochs_b18_imagenetTL_checkpoint.pth')

with open("/noether/s0/cfw5463/Model/2000epochs_b18_imagenetTL_perfromance", "wb") as fp:   #Pickling
  pickle.dump(performance_record, fp)
  
# to save model
PATH = '/noether/s0/cfw5463/Model/2000epochs_b18_imagenetTL_model.pth'
...
plt.savefig("/noether/s0/cfw5463/Model/2000epochs_b18_imagenetTL_MSE_best.png", dpi=600)
plt.show()
...
plt.savefig("/noether/s0/cfw5463/Model/2000epochs_b18_imagenetTL_MAE_best.png", dpi=600)
plt.show()
...
with open('/noether/s0/cfw5463/Data/IMTL_x_vals.pkl', 'wb') as fid:
  pickle.dump(x_vals, fid)


with open('/noether/s0/cfw5463/Data/IMTL_y_vals.pkl', 'wb') as fid:
...
ax.scatter(x_vals, y_vals, s = 8,  label = 'Data')
...
ax.set_title('R2: ' + str(r2_score(x_vals, y_vals)), fontsize=30)
ax.set_xlabel('Coverage', fontsize=30)
ax.set_ylabel('CNN coverage', fontsize=30)
ax.legend()
fig.savefig("/noether/s0/cfw5463/Model/2000patch_Train_from_scratch_parity2.png", dpi=600)
fig.show()