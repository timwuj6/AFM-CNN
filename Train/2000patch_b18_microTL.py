...
optimizer = optim.Adam(model_micro.parameters(), lr=0.0000001)#, weight_decay = 0.0001) # 0.005 was used in the saved model I
...
for epoch in range(1, 500):  # loop over the dataset multiple times  2000,3000
  running_loss = 0.0
...
checkpoint = {'state_dict': model_micro.state_dict(),
              ...
              'epoch': epoch,
              'loss': loss}
torch.save(checkpoint, '/noether/s0/cfw5463/Model/2000epochs_b18_micronetTL_checkpoint.pth')

with open("/noether/s0/cfw5463/Model/2000epochs_b18_micronetTL_perfromance", "wb") as fp:   #Pickling
  pickle.dump(performance_record, fp)
  
# to save model
PATH = '/noether/s0/cfw5463/Model/2000epochs_b18_micronetTL_model.pth'
...
plt.savefig("/noether/s0/cfw5463/Model/2000epochs_b18_micronetTL_MSE_best.png", dpi=600)
plt.show()
...
plt.savefig("/noether/s0/cfw5463/Model/2000epochs_b18_micronetTL_MAE_best.png", dpi=600)
plt.show()
...
with open('/noether/s0/cfw5463/Data/MCTL_x_vals.pkl', 'wb') as fid:
  pickle.dump(x_vals, fid)


with open('/noether/s0/cfw5463/Data/MCTL_y_vals.pkl', 'wb') as fid:
...
plt.title('R2: ' + str(r2_score(x_vals, y_vals)))
plt.xlabel('Coverage', fontsize=15)
plt.ylabel('CNN coverage', fontsize=15)
plt.legend()
plt.savefig("/noether/s0/cfw5463/Model/2000epochs_b18_micronetTL_parityplot.png", dpi=600)
plt.show()